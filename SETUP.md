...
Authoritative procedures live in **[AGENTS.md](AGENTS.md)** (Setup checklist, Docker, LAN, scheduled jobs). This file is a **thin index** aligned with the SSOT map in [docs/PROJECT.md](docs/PROJECT.md).
...
- **[docs/memory-store-parity.md](docs/memory-store-parity.md)** — **one Postgres** for local + production; optional **`POST /api/memory/bridge`** + **`pnpm memory:bridge`**
