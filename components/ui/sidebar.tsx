    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="inset-x-0 bottom-0 top-auto flex h-[min(88dvh,calc(100dvh-env(safe-area-inset-bottom)-0.75rem))] max-h-[92dvh] w-full rounded-t-2xl border-t border-border/30 bg-sidebar p-0 pt-10 text-sidebar-foreground"
