...
| Optional pruning inventory (single-owner simplifications; business/front-desk stack removed 2026-04) | [docs/PRUNING_CANDIDATES.md](PRUNING_CANDIDATES.md) |
...
| Sophon daily command center (Option B v1) | UI lives under **`/command-center`** (`?section=daily`); API `app/(chat)/api/sophon/daily/route.ts`, `sophon/src/`, `sophon/tests/`, [docs/superpowers/specs/2026-04-05-sophon-daily-command-center-design.md](superpowers/specs/2026-04-05-sophon-daily-command-center-design.md) |
...
| Command center (flight deck triage + background activity + daily Sophon; card→runbook mapping, manual digest action) | [docs/operator-integrations-runbook.md](operator-integrations-runbook.md) § *Operator flight deck*; UI `app/(chat)/command-center/`, API `app/(chat)/api/flight-deck/`, `lib/reliability/flight-deck-metrics.ts` |
| Through June 2026 — observe real use, prioritize embeddings/retrieval, daily use + weekly v2-eval review | [docs/STABILITY_TRACK.md](STABILITY_TRACK.md) — section *Through June 2026 — operator focus* |
...
| January 2024 Phase 1 archive (historical; superseded for onboarding by README → SETUP → this file + AGENTS) | [docs/archive/phase1/README.md](archive/phase1/README.md); stubs at legacy paths still work; index: [DOCUMENTATION_INDEX.md](../DOCUMENTATION_INDEX.md), [START_HERE.md](../START_HERE.md) |
...
| Virgil 1.1 bridge and mid-June / mid-August execution timeline | [docs/V1_1_TO_V2_EXECUTION_TIMELINE.md](V1_1_TO_V2_EXECUTION_TIMELINE.md) |
